...
Создан модуль MyEvolModule, в котором создан пользовательский тип данных MyEvolution. Далее MyEvolution делается экземпляром классов Show, Read, Ord, Eq, Enum и Bounded, без использования ключевого слова deriving.
